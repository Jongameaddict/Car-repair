      ...
      <button class="hamburger" :class="{ open: isMenuOpen }" @click="toggleMenu">
        ...
        <ul>
            <li v-for="request in requests" :key="request.id">
                ...
                <button v-if="request.status !== 'completed'" @click="markCompleted(request.id)">Mark complete</button>
                <button v-if="request.status === 'completed'" @click="repairCompleted(request.id)">Your repair is completed</button>
            </li>
        </ul>
